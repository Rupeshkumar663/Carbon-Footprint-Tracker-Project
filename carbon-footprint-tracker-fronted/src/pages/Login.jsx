      ...
      <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={handleLogin}>
        ...
        <div className='md:w-[50%] h-[100%] flex flex-col items-center justify-center gap-3'>
          ...
          <div className='flex flex-col gap-1 w-[80%] items-start justify-center px-3 relative'>
            ...
            <input id='password' type={show ? "text" : "password"} className='border-1 w-[100%] h-[35px] border-[#e7e6e6] text-[15px] p-[20px]' placeholder='Your password' onChange={(e)=>setPassword(e.target.value)} value={password}/>
            {!show ? 
          ...
          <button className='w-[80%] h-[40px] bg-black text-white cursor-pointer flex items-center justify-center rounded-[5px]' type="submit" disabled={loading}>
